		...
		$.fbuilder.controls[ 'ffields' ].prototype,
		{
			...
			editItemEvents:function()
				...
				showChoiceIntance: function()
				{
                    ...
                    return '<div class="choicesSet '+((this.showDep)?"show":"hide")+'"><label>Choices <a class="helpfbuilder dep video" href="https://www.youtube.com/embed/s4FM59LC-H4?list=PLY-AOoHciOKgZQsqWfkQlHJ21sm3qPF9X" target="_blank">&#9654; help?</a> <a href="" class="showHideDependencies">'+((this.showDep)?"Hide":"Show")+' Dependencies</a></label><div class="choicesHeadersLine"><div class="t">Text</div><div class="t">Value</div><div>optgroup</div></div>'+str+
                    ...
                    this.firstChoice()+this.mergeValues()+this.attributeToSubmit()+this.multipleSelection()+'</div>';
				}
	});