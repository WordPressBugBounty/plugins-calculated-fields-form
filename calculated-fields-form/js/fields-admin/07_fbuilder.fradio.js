			...
			showChoiceIntance: function()
				{
					...
					for (var i=0;i<l.length;i++)
					{
						...
						'<input class="choice_radio" i="'+i+'" type="radio" '+((this.choiceSelected==l[i]+' - '+lv[i])?"checked":"")+' name="choice_radio" title="Choice selected by default" aria-label="Select choice by default" />'+
                    ...
                    this.attributeToSubmit()+this.allowUntick()+'</div>';
				}
	});