			...
			editItemEvents:function()
				{
					var evt=[
						...
						{s:"#sAlignTop",e:"click", l:"align",f:function(el){
							...
							$('#sAlignTop').removeClass('button-secondary').addClass('button-primary');
							return 'top';
						}},
						{s:"#sAlignBottom",e:"click", l:"align",f:function(el){
							$('#sAlignTop').removeClass('button-primary').addClass('button-secondary');
							$('#sAlignBottom').removeClass('button-secondary').addClass('button-primary');
							return 'bottom';
						}}
					];
