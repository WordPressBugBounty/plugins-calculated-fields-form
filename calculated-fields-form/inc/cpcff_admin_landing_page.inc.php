		...
		<div class="inside" style="padding:0;">
			...
			<div style="padding:20px;">
				<div class="cff-video-tutorial-other-videos">
					...
					<div class="cff-video-tutorial-thumbnail"><a href="https://youtu.be/ZF5SoaKVmOg" target="_blank"><img src="<?php print esc_attr( plugins_url('../images/th-video-10.png', __FILE__) ); ?>" alt="<?php esc_attr_e('MCP AI Agents', 'calculated-fields-form'); ?>"></a><div class="cff-video-tutorial-thumbnail-title"><a href="https://cff.dwbooster.com/download" target="_blank"><?php esc_html_e('MCP AI Agents', 'calculated-fields-form'); ?></a></div></div>
