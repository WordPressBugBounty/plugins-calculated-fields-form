		...
		<div class="inside" style="padding:0;">
			...
			<div style="padding:20px;">
				<div class="cff-video-tutorial-other-videos">
					...
					<div class="cff-video-tutorial-thumbnail"><a href="https://youtu.be/ZF5SoaKVmOg" target="_blank"><img src="<?php print esc_attr( plugins_url('../images/th-video-10.png', __FILE__) ); ?>" alt="<?php esc_attr_e('MCP AI Agents', 'calculated-fields-form'); ?>"></a><div class="cff-video-tutorial-thumbnail-title"><a href="https://cff.dwbooster.com/download#comparison" target="_blank"><?php esc_html_e('MCP AI Agents', 'calculated-fields-form'); ?></a></div></div>
					<div class="cff-video-tutorial-thumbnail"><a href="https://youtu.be/X3nByJtaXzA" target="_blank"><img src="<?php print esc_attr( plugins_url('../images/th-video-5.png', __FILE__) ); ?>" alt="<?php esc_attr_e('WooCommerce Integration', 'calculated-fields-form'); ?>"></a><div class="cff-video-tutorial-thumbnail-title"><a href="https://cff.dwbooster.com/download#comparison" target="_blank"><?php esc_html_e('WooCommerce', 'calculated-fields-form'); ?></a></div></div>
					<div class="cff-video-tutorial-thumbnail"><a href="https://youtu.be/TXLMB3_w-Xg" target="_blank"><img src="<?php print esc_attr( plugins_url('../images/th-video-6.png', __FILE__) ); ?>" alt="<?php esc_attr_e('PDF Generator', 'calculated-fields-form'); ?>"></a><div class="cff-video-tutorial-thumbnail-title"><a href="https://cff.dwbooster.com/download#comparison" target="_blank"><?php esc_html_e('PDF/Invoice', 'calculated-fields-form'); ?></a></div></div>
					<div class="cff-video-tutorial-thumbnail"><a href="https://youtu.be/Z2h_yFiXp9A" target="_blank"><img src="<?php print esc_attr( plugins_url('../images/th-video-7.png', __FILE__) ); ?>" alt="<?php esc_attr_e('Google Sheets', 'calculated-fields-form'); ?>"></a><div class="cff-video-tutorial-thumbnail-title"><a href="https://cff.dwbooster.com/download#comparison" target="_blank"><?php esc_html_e('Google Sheets', 'calculated-fields-form'); ?></a></div></div>
			...
			<div style="padding:20px;background:#000000;" class="cff-why-upgrade">
				...
				<div class="cff-lading-page-advanced-columns">
					...
					<div class="cff-lading-page-advanced-col3">
						...
						if (true || $currentTime < $targetTime) {
							print '<div style="font-size:32px;text-align:center;">';
							print '<span style="font-size:20px;color:yellow;">Special Offer!</span><br>';
							print '€29.99';
							print '</div>';
						}
						else {
						...
						<div style="margin-top:30px;text-align:center;"><a href="https://cff.dwbooster.com/download#comparison" target="_blank" class="cff-secondary-button" style="width:auto;padding-left:20px;padding-right:20px;"><?php esc_html_e( 'UPGRADE!', 'calculated-fields-form' ); ?></a></div>
					</div>
				</div>
			</div>
			<table border="0" style="width:100%;margin-top:20px;">
				<tr style="border:0;">
					...
					<td style="border:0;text-align:center;">
						<a href="https://cff.dwbooster.com/download#comparison" target="_blank" style="font-size:16px;"><?php esc_html_e( 'Upgrade your plugin copy', 'calculated-fields-form' ); ?></a>
					</td>
				</tr>
			</table>
		</div>
