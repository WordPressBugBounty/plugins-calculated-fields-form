...
<div id="cff-video-tutorial-modal" style="display:<?php print esc_attr( get_transient( 'cff-video-tutorial' ) ? 'block' : 'none' ); ?>;">
	<div id="cff-video-tutorial">
		...
		<div class="cff-video-tutorial-other-videos">
			...
			<div class="cff-video-tutorial-thumbnail" style="border: 2px dashed purple;"><a href="https://youtu.be/ZF5SoaKVmOg" target="_blank"><img src="<?php print esc_attr( plugins_url('../images/th-video-10.png', __FILE__) ); ?>" alt="<?php esc_attr_e('MCP AI Agents', 'calculated-fields-form'); ?>"></a><div class="cff-video-tutorial-thumbnail-title"><a href="https://cff.dwbooster.com/download#comparison" target="_blank"><?php esc_html_e('MCP AI Agents', 'calculated-fields-form'); ?></a></div></div>
			<div class="cff-video-tutorial-thumbnail" style="border: 2px dashed purple;"><a href="https://youtu.be/X3nByJtaXzA" target="_blank"><img src="<?php print esc_attr( plugins_url('../images/th-video-5.png', __FILE__) ); ?>" alt="<?php esc_attr_e('WooCommerce Integration', 'calculated-fields-form'); ?>"></a><div class="cff-video-tutorial-thumbnail-title"><a href="https://cff.dwbooster.com/download#comparison" target="_blank"><?php esc_html_e('WooCommerce', 'calculated-fields-form'); ?></a></div></div>
			<div class="cff-video-tutorial-thumbnail" style="border: 2px dashed purple;"><a href="https://youtu.be/TXLMB3_w-Xg" target="_blank"><img src="<?php print esc_attr( plugins_url('../images/th-video-6.png', __FILE__) ); ?>" alt="<?php esc_attr_e('PDF Generator', 'calculated-fields-form'); ?>"></a><div class="cff-video-tutorial-thumbnail-title"><a href="https://cff.dwbooster.com/download#comparison" target="_blank"><?php esc_html_e('PDF/Invoice', 'calculated-fields-form'); ?></a></div></div>
			<div class="cff-video-tutorial-thumbnail" style="border: 2px dashed purple;"><a href="https://youtu.be/Z2h_yFiXp9A" target="_blank"><img src="<?php print esc_attr( plugins_url('../images/th-video-7.png', __FILE__) ); ?>" alt="<?php esc_attr_e('Google Sheets', 'calculated-fields-form'); ?>"></a><div class="cff-video-tutorial-thumbnail-title"><a href="https://cff.dwbooster.com/download#comparison" target="_blank"><?php esc_html_e('Google Sheets', 'calculated-fields-form'); ?></a></div></div>
			<div class="cff-video-tutorial-thumbnail" style="border: 2px dashed purple;"><a href="https://youtu.be/b5OU3Qzxk-Q" target="_blank"><img src="<?php print esc_attr( plugins_url('../images/th-video-9.png', __FILE__) ); ?>" alt="<?php esc_attr_e('Signature', 'calculated-fields-form'); ?>"></a><div class="cff-video-tutorial-thumbnail-title"><a href="https://cff.dwbooster.com/download#comparison" target="_blank"><?php esc_html_e('Signature', 'calculated-fields-form'); ?></a></div></div>
...
<div id="cff-video-tutorial-ds-modal" style="display:none;">
	<div id="cff-video-tutorial-ds">
		...
		<div class="cff-video-tutorial-container">
			<iframe src="https://www.youtube.com/embed/Z2h_yFiXp9A" title="Calculated Fields Form Plugin - Using DS fields" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="" loading="lazy"></iframe>
		</div>
